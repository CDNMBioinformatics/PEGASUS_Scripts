...
## 1.2. Lipidomics-positive halfmin imputed data 
...
save(lipid_pos_dat, lipid_pos_mets_info, file = here(dat_dir, "lipid_pos_data_updated.RData"))
...
stratum_to_rm <- lipid_pos_dat[is.na(Collect_Date) | is.na(bmi) | abs(bmi_timegap_y) > 5, unique(Stratum)]
stratum_to_rm <- c(stratum_to_rm, lipid_pos_dat[, .N, Stratum][N == 1, Stratum]); length(stratum_to_rm)
lipid_pos_dat_trim <- lipid_pos_dat[!(Stratum %in% stratum_to_rm), ]
...
lipid_pos_dat_excl <- lipid_pos_dat_trim[!(Stratum %in% comorb_excl), ]
...
dat_tmp <- lipid_pos_dat_trim[Stratum %in% lipid_pos_dat_trim[ocs_ard_serum_coll == 0, Stratum], ]
...
res_3_1_2_1 <- clogi_res_fnc(outc = "asthma_num", 
                             mets_list = feat_list, 
                             dat = "lipid_pos_dat_excl", 
                             mets_info = "lipid_pos_mets_info", 
                             add_covar = " + bmi")
# datatable(res_3_1_2_1[tentative_annotation != "Unknown"], filter = "top") %>% 
#         formatSignif(columns = num_cols, digits = sig_digits)

dat_tmp <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[ocs_ard_serum_coll == 0, Stratum], ]
...
dat_tmp <- lipid_pos_dat_excl[asthma_num == 1, ]
...
saveRDS(res_overall, file = here(res_dir, "res_overall_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Gender == "F", ]
...
dat_tmp2 <- lipid_pos_dat_excl[Gender == "F" & asthma_num == 1, ]
...
saveRDS(res_female, file = here(res_dir, "res_female_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Gender == 'M', ]
...
dat_tmp2 <- lipid_pos_dat_excl[Gender == "M" & asthma_num == 1, ]
...
saveRDS(res_male, file = here(res_dir, "res_male_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & ics_trim_totnum_1y > 0, Stratum], ]
...
dat_tmp2 <- lipid_pos_dat_excl[ics_trim_totnum_1y > 0 & asthma_num == 1, ]
...
saveRDS(res_ics_1y_y, file = here(res_dir, "res_ics_1y_y_lipid_pos.rds"))
...
saveRDS(res_ics_1y_n, file = here(res_dir, "res_ics_1y_n_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & eos >= 0.3, Stratum], ]
...
dat_tmp2 <- lipid_pos_dat_excl[asthma_num == 1 & eos >= 0.3, ]
...
saveRDS(res_eos_high, file = here(res_dir, "res_eos_high_lipid_pos.rds"))
...
saveRDS(res_eos_low, file = here(res_dir, "res_eos_low_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & 
...
dat_tmp2 <- lipid_pos_dat_excl[asthma_num == 1 & asthma_exacerbation_trim_totnum_1y > 0, ]
...
saveRDS(res_exac_1y_y, file = here(res_dir, "res_exac_1y_y_lipid_pos.rds"))
...
saveRDS(res_exac_1y_n, file = here(res_dir, "res_exac_1y_n_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & bmi >= 30, Stratum], ]
...
dat_tmp2 <- lipid_pos_dat_excl[asthma_num == 1 & bmi >= 30, ]
...
saveRDS(res_bmi_high, file = here(res_dir, "res_bmi_high_lipid_pos.rds"))
...
saveRDS(res_bmi_low, file = here(res_dir, "res_bmi_low_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & ocs_trim_totnum_1y > 0, Stratum], ]
...
dat_tmp2 <- lipid_pos_dat_excl[ocs_trim_totnum_1y > 0 & asthma_num == 1, ]
...
saveRDS(res_ocs_1y_y, file = here(res_dir, "res_ocs_1y_y_lipid_pos.rds"))
...
saveRDS(res_ocs_1y_n, file = here(res_dir, "res_ocs_1y_n_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & allergy_ever == 1, Stratum], ]
...
dat_tmp2 <- lipid_pos_dat_excl[asthma_num == 1 & allergy_ever == 1, ]
...
saveRDS(res_ige_high, file = here(res_dir, "res_allergy_y_lipid_pos.rds"))
...
dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & allergy_ever == 0, Stratum], ]
...
dat_tmp2 <- lipid_pos_dat_excl[asthma_num == 1 & allergy_ever == 0, ]
...
saveRDS(res_ige_norm, file = here(res_dir, "res_allergy_n_lipid_pos.rds"))
...
neut_median <- median(lipid_pos_dat_excl$neut, na.rm = T)
neut_median


## Asthmatics vs controls

dat_tmp1 <- lipid_pos_dat_excl[Stratum %in% lipid_pos_dat_excl[asthma_num == 1 & neut >= neut_median, Stratum], ]
...
dat_tmp2 <- lipid_pos_dat_excl[asthma_num == 1 & neut >= neut_median, ]
...
saveRDS(res_neut_high, file = here(res_dir, "res_neut_high_lipid_pos.rds"))
...
saveRDS(res_neut_low, file = here(res_dir, "res_neut_low_lipid_pos.rds"))
...
lipid_pos_dat_excl[asthma_num == 1, eos_high := case_when(eos >= 0.3 ~ 1, 
                                                          eos < 0.3 ~ 0)]
lipid_pos_dat_excl[asthma_num == 1, obese := case_when(bmi >= 30 ~ 1, 
                                                       bmi < 30 ~ 0)]
lipid_pos_dat_excl[, female := case_when(Gender == "F" ~ 1, 
                                       Gender == "M" ~ 0)]
lipid_pos_dat_asthma <- lipid_pos_dat_excl[asthma_num == 1, ]
...
lipid_pos_dat_asthma[, .N, eos_high]
res_high_vs_low_eos <- logi_res_fnc(outc = "eos_high", 
                                    mets_list = feat_list, 
                                    dat = "lipid_pos_dat_asthma", 
                                    mets_info = "lipid_pos_mets_info", 
                                    add_covar = " + Gender + bmi")
...
lipid_pos_dat_asthma[, .N, allergy_ever]
...
lipid_pos_dat_ctrl <- lipid_pos_dat_excl[asthma_num == 0, ]

res_female_vs_male_ctrl <- logi_res_fnc(outc = "female", 
                                        mets_list = feat_list, 
                                        dat = "lipid_pos_dat_ctrl", 
                                        mets_info = "lipid_pos_mets_info", 
                                        add_covar = " + bmi")
...
saveRDS(res_compare_asthmatics, file = here(res_dir, "res_compare_dif_asthmatics_lipid_pos.rds"))
...
lipid_pos_dat_asthma[, summary(eos)]
ggplot(lipid_pos_dat_asthma) + geom_histogram(aes(eos), bins = 100)
...
lipid_pos_dat_asthma[, summary(fev1_prebd_pctpred)]
ggplot(lipid_pos_dat_asthma) + geom_histogram(aes(fev1_prebd_pctpred), bins = 100)
...
lipid_pos_dat_asthma[, summary(fvc_prebd_pctpred)]
ggplot(lipid_pos_dat_asthma) + geom_histogram(aes(fvc_prebd_pctpred), bins = 100)
...
lipid_pos_dat_asthma[, summary(neut)]
ggplot(lipid_pos_dat_asthma) + geom_histogram(aes(neut), bins = 100)
...
saveRDS(res_qt_asthmatics, file = here(res_dir, "res_qt_asthmatics_lipid_pos.rds"))
