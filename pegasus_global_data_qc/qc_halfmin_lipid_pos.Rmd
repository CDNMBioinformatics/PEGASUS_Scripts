...
subtitle: "Lipidomics Positive - Half-minimum Imputation"
author: "MHuang"
date: "8/31/2020"
output: 
  html_document: 
...
pc_alldat <- cbind(pc_alldat, dat[, Group]) %>% setnames(., "V2", "Group")
...
ggsave(here(fig_dir, "PC1_PC2_qc_sample_positions_halfmin.png"), height = 6, width = 9)
...
save(samp_dat_final, samp_mets_cols, mets_info, samp_na, samp_dat_origscale, 
     file = here(post_qc_dir, "processed_lipid_pos_halfmin.RData"))
