...
subtitle: "Lipidomics Negative - kNN Imputation"
author: "MHuang"
date: "9/14/2020"
output: 
  html_document: 
...
fig_dir <- "figures/lipid_neg/"
post_qc_dir <- "post_qc_data/lipid_neg/"


## Filenames

dat_fname <- str_c(dat_dir, "2020-08-21_EXP00020_PEGASuS_LIPIDOMICS_NEG_MSDIAL_PeakArea_curated_QCCorred_ForHarvard.xlsx")
dat_sheetname <- "DATA"
...
qc_dat <- copy(dat[SampleGroup == "QC", ])
...
pc_pre <- cbind(pc_pre, samp_dat[, SampleGroup]) %>% setnames(., "V2", "SampleGroup")
...
ggplot(samp_dat_final, aes(x = PC1, y = PC2)) + 
        ...
        geom_label_repel(aes(label = ifelse(PC1 > 50, sampleID_biobank, "")),
                  box.padding   = 0.25, 
                  point.padding = 0.5,
...
save(samp_dat_final, samp_mets_cols, mets_info, samp_na, samp_dat_origscale, 
     file = here(post_qc_dir, "processed_lipid_neg_knn.RData"))
